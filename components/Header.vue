<template>
    <header class="bg-[#4B5136] py-4 shadow-md">
      ...
      <!-- Mobile menu -->
      <div v-if="menuOpen" class="md:hidden px-6 mt-2 space-y-2 text-[#A8A35E] font-medium">
        <a href="#" class="block hover:text-[#EFE49D]">Inicio</a>
